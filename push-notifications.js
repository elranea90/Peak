...
function initPushNotifications() {
  ...
  navigator.serviceWorker.register('/firebase-messaging-sw.js')
    ...
    .catch(err => {
      ...
      console.error('Asegúrate de que el archivo firebase-messaging-sw.js está en la raíz de tu sitio web');
      console.error('URL esperada:', window.location.origin + '/firebase-messaging-sw.js');
    });
}
...
async function suscribirATopic(token) {
  try {
    ...
    // ⚠️ IMPORTANTE: Actualiza esto con tu PROJECT_ID real
    const functionUrl = 'https://europe-west1-peakturnos.cloudfunctions.net/subscribeCliente';
